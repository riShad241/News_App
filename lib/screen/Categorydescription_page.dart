...
class CategoryDescriotionPage extends StatefulWidget {
  final CategoryArticals article;
  const CategoryDescriotionPage({Key? key, required this.article}) : super(key: key);

  @override
  State<CategoryDescriotionPage> createState() => _CategoryDescriotionPageState();
}

class _CategoryDescriotionPageState extends State<CategoryDescriotionPage> {
